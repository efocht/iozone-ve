...
#
# NCC for Aurora Tsubasa
#
linux-VE: 	iozone_linux-VE.o  libbif.o fileop_linux-VE.o pit_server_linux-VE.o
	$(VCC)  -O3 $(LDFLAGS) iozone_linux-VE.o libbif.o \
		-lrt -lpthread -o iozone
	$(VCC)  -O3 -Dlinux fileop_linux-VE.o -o fileop
	$(VCC)  -O3 -Dlinux pit_server_linux-VE.o -o pit_server
...
pit_server_linux-VE.o:  pit_server.c
	@echo ""
	@echo "Building the pit_server"
	@echo ""
	$(VCC) -c  $(CFLAGS) pit_server.c  -o pit_server_linux-VE.o
...
fileop_linux-VE.o:	fileop.c
	@echo ""
	@echo "Building fileop for Linux-VE"
	@echo ""
	$(VCC) -Wall -c -O3 $(CFLAGS) fileop.c -o fileop_linux-VE.o
...
iozone_linux-VE.o:	iozone.c libbif.c
	@echo ""
	@echo "Building iozone for Linux-VE"
	@echo ""
	$(VCC) -c -O3 -Dunix -DHAVE_ANSIC_C -DNAME='"linux-VE"' \
		-D__VE__ -DSHARED_MEM -Dlinux -D_LARGEFILE64_SOURCE \
		-DHAVE_PREAD $(CFLAGS) iozone.c -o iozone_linux-VE.o
	$(VCC) -c -O3 -Dunix -DHAVE_ANSIC_C -D_LARGEFILE64_SOURCE \
		-DSHARED_MEM -Dlinux $(CFLAGS) libbif.c -o libbif.o
